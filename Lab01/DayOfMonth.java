...
public class DayOfMonth {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.print("Nguyen Phuc Anh - 20225784 : Please enter a year: ");
            strYear = sc.nextLine();
            ...
            System.out.println("Nguyen Phuc Anh - 20225784 : Year invalid! Please enter again.");
        } while (true);
        do {
            System.out.print("Nguyen Phuc Anh - 20225784 : Please enter a month: ");
            month = sc.nextLine();
            if(month.equals("January") || month.equals("Jan") || month.equals("Jan.") || month.equals( "1")){
                ...
                System.out.println("Nguyen Phuc Anh - 20225784 : Invalid month! Please enter again");
            }
        } while (true);
